"""
OIndex_ArgHandle is a library made to simplify using arguments with a ALMOST Pure-Python implementation.
This version of arghandle uses sys.argv[0] instead of starting with [1]

Read the documentation at the github repo (https://github.com/alanbutidk/arghandle)
"""
...
class OIndex_ArgHandle:
    ...
    def __repr__(self):
        return f"OIndex_ArgHandle(ProgramName={self._ProgramName!r}, Version={self._Version!r})"
